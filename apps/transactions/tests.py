...
class TransactionApiTests(APITestCase):
    ...
    def test_successful_transfer(self):
        ...
        self.assertEqual(Transaction.objects.get().status, Transaction.Status.SUCCESS)
...
class TransferServiceTests(TestCase):
    ...
    def test_create_transfer_success(self):
        ...
        self.assertEqual(transfer.status, Transaction.Status.SUCCESS)
    ...
    def test_create_transfer_fails_when_currency_differs(self):
        ...
        self.assertEqual(failed_transaction.status, Transaction.Status.FAILED)
        self.assertIn("same currency", failed_transaction.failure_reason)
    ...
    def test_create_transfer_fails_for_same_account(self):
        ...
        failed_transaction = Transaction.objects.get()
        self.assertEqual(failed_transaction.status, Transaction.Status.FAILED)
        self.assertIn("must be different", failed_transaction.failure_reason)
